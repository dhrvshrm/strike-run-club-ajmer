...
import { Container, Typography, Box, Button, Paper, Chip, CircularProgress } from "@mui/material";
        ...
        <Grid2 container spacing={4}>
          <Grid2 size={{ xs: 12, md: 8 }}>
            ...
            >
              <Paper
                elevation={0}
                sx={{ overflow: "hidden", border: "1px solid", borderColor: "divider", borderRadius: 3 }}
              >
                <Box
                  sx={{
          ...
          <Grid2 size={{ xs: 12, md: 4 }}>
            ...
            >
              {!isPast && (
                <Paper
                  elevation={0}
                  sx={{ p: 3, border: "1px solid", borderColor: "divider", borderRadius: 3, mb: 3 }}
                >
                  <Typography variant="h6" fontWeight={600} sx={{ mb: 2 }}>
                    Event Starts In
                  </Typography>
